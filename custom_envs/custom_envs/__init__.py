...
POINT_LEN = 250 # numbe of steps in each episode, default: 150
...
register(
    id="PointHalfCircle-v0",
    entry_point=ABS_PATH+".point:PointHalfCircle",
    max_episode_steps=POINT_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="PointHalfCircleTest-v0",
    entry_point=ABS_PATH+".point:PointHalfCircleTest",
    max_episode_steps=POINT_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="PointObstacle-v0",
    entry_point=ABS_PATH+".point:PointObstacle",
    max_episode_steps=POINT_LEN-75,
    reward_threshold=None,
    nondeterministic=False,
)

register(
    id="PointObstacleTest-v0",
    entry_point=ABS_PATH+".point:PointObstacleTest",
    max_episode_steps=POINT_LEN-75,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="PointObstacle2-v0",
    entry_point=ABS_PATH+".point:PointObstacle2",
    max_episode_steps=POINT_LEN-75,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="PointObstacle2Test-v0",
    entry_point=ABS_PATH+".point:PointObstacle2Test",
    max_episode_steps=POINT_LEN-75,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="PointDS-v0",
    entry_point=ABS_PATH+".point:PointDS",
    max_episode_steps=POINT_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
register(
    id="PointDSTest-v0",
    entry_point=ABS_PATH+".point:PointDSTest",
    max_episode_steps=POINT_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="PointEllip-v0",
    entry_point=ABS_PATH+".point:PointEllip",
    max_episode_steps=POINT_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="PointEllipTest-v0",
    entry_point=ABS_PATH+".point:PointEllipTest",
    max_episode_steps=POINT_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="UR5Env-v0",
    entry_point=ABS_PATH+".UR5:UR5Env",
...
register(
    id="UR5WithPos-v0",
    entry_point=ABS_PATH+".UR5:UR5WithPos",
    max_episode_steps=150,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="UR5WithPosTest-v0",
    entry_point=ABS_PATH+".UR5:UR5WithPosTest",
    max_episode_steps=150,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="UR5WithPosTransTest-v0",
    entry_point=ABS_PATH+".UR5:UR5WithPosTransTest",
    max_episode_steps=150,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="UR5WithPosTrans-v0",
    entry_point=ABS_PATH+".UR5:UR5WithPosTrans",
    max_episode_steps=150,
    reward_threshold=None,
    nondeterministic=False,
)
